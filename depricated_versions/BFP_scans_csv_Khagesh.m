...
% x=linspace(0, 150,dim(1));
% y=linspace(0, 150,dim(2));
...
figure(1)
imagesc(data_cell{1,2},data_cell{2,2},data_cell{3,2}'.*10^3)
colormap(gray);
a = colorbar
a.Title.String = 'mV';
...
figure(2)
imagesc(data_cell{1,2},data_cell{2,2},data_cell{4,2}'.*10^3) % add .*10^3
...
figure(3)
imagesc(data_cell{1,2},data_cell{2,2},data_cell{5,2}'.*10^3) % add .*10^3
colormap(redblue(10000));
a = colorbar
a.Title.String = 'mV';
addToolbarExplorationButtons(gcf)
...
figure(4)
imagesc(data_cell{1,2},data_cell{2,2},data_cell{6,2}'.*10^3)
colormap(redblue(10000));
a = colorbar
a.Title.String = 'mV';
addToolbarExplorationButtons(gcf)
...
figure(5)
imagesc(data_cell{1,2},data_cell{2,2},data_cell{7,2}'.*10^3)
colormap(redblue(10000));
a = colorbar
a.Title.String = 'mV';
addToolbarExplorationButtons(gcf)
...
for i = 3:7
    ...
    saveas(figure(i-2),append(savedir,name))
